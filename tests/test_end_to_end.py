...
def test_synthetic_trip_pipeline() -> None:
    ...
    media=[
        MediaPoint(id="a",filename="a.jpg",path=Path("a.jpg"),media_type=MediaType.PHOTO,captured_at=base,latitude=27.67,longitude=85.32,gps_quality=GPSQuality.VALID),
        MediaPoint(id="b",filename="b.jpg",path=Path("b.jpg"),media_type=MediaType.PHOTO,captured_at=base+timedelta(hours=1),latitude=27.70,longitude=85.35,gps_quality=GPSQuality.VALID),
    ]
